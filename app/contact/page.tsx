        ...
        <div data-reveal>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-olive dark:bg-navy-900 border border-sage-200 dark:border-navy-800 flex items-center justify-center text-gold-700 dark:text-gold-400 shrink-0">
