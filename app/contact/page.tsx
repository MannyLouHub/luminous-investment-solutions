  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20">
      <div className="grid md:grid-cols-2 gap-16">
        <div data-reveal>
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-gold-600 dark:text-golden mb-2">Get in touch</p>
          <h1 className="text-4xl font-bold text-navy-950 dark:text-beige mb-6">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-olive dark:bg-navy-900 border border-sage-200 dark:border-navy-800 flex items-center justify-center text-gold-700 dark:text-golden shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
              </div>
              <div>
                <p className="text-sm font-semibold text-navy-950 dark:text-beige">Email</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-navy-950 dark:text-beige">Location</p>
                <p className="text-sm text-navy-500 dark:text-navy-400">Pennsylvania</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-navy-950 dark:text-beige">Newsletter</p>
                <a
