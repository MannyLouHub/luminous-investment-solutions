        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map(post => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group bg-white dark:bg-navy-900 rounded-2xl p-6 border border-navy-100 dark:border-navy-800 hover:border-gold-500 dark:hover:border-gold-600 transition-colors flex flex-col"
            >
              ...
              <div className="flex items-center justify-between mt-5 pt-4 border-t border-navy-100 dark:border-navy-800">
